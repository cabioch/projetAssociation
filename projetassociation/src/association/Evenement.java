...
public class Evenement implements java.io.Serializable {
   ...
   * chevauchement.
   *
   * @param evt Un evenement (non null)
   ...
   * d'une dur�e et d'un nombre de participants maximum.
   *
  ...
  public Evenement(String nom, String lieu, int annee, Month mois, int jour,
    ...
    this.participants = new HashSet<>();
    // En cas de paramètres non valides (potentiellement inutile car déjà faite
    // par LocalDateTime ??
    if (!(jour >= 1 && jour <= 31 && heure >= 0 && heure <= 23 && minutes >= 0
        && minutes <= 59)) {
      return;
    }
